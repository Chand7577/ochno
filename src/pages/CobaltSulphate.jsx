...
const CobaltSulphate = () => {
  ...
  const specs = [
    ...
    {
      p: "Appearance",
      v: "Pink/red crystalline powder",
      i: "Pink/red crystalline",
      r: "Pink/red crystalline",
    },
    {
      p: "Solubility",
      v: "Completely soluble in water",
      i: "Completely soluble",
      r: "Completely soluble",
    },
    ...
    },
    {
      ...
      v: "China / Finland",
      i: "China",
      r: "India (certified recyclers)",
    },
    {
      p: "Price position",
      v: "Premium",
      i: "Standard",
      r: "Cost-effective (15-30% lower)",
    },
  ];
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-6 text-center">
          ...
          <Reveal variant="fadeUp" delay={600}>
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto font-light leading-relaxed mb-12 italic">
              "Virgin Imported Grade · Recycled India Grade — Two Sources, Two
              Price Points, One Supplier"
            </p>
          </Reveal>
          <Reveal
            variant="fadeUp"
          ...
          >
            ...
            <Link
              to="/contact"
              className="bg-white/5 text-white border border-white/10 px-10 py-5 rounded-2xl font-black hover:bg-white/10 transition-all backdrop-blur-md"
            >
              Offer Your Supply
            </Link>
          </Reveal>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <Reveal className="text-center mb-24">
            ...
            <p className="text-gray-500 max-w-2xl mx-auto text-lg font-light">
              We supply cobalt sulphate from two distinct sources — tailored for
              purity requirements or cost-efficiency.
            </p>
          </Reveal>
              ...
              <div className="relative h-full bg-[#f8f9fb] p-12 rounded-[3rem] overflow-hidden border border-gray-100 transition-all duration-500 hover:shadow-2xl hover:bg-white">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-3xl font-black text-navy mb-6">
                    Virgin Cobalt Sulphate{" "}
                    <span className="text-wine block text-xl">(Imported)</span>
                  </h3>
                  <p className="text-gray-600 leading-relaxed mb-8">
                    Produced from primary cobalt metal or high-purity
                    intermediate compounds. Sourced from premier refining chains
                    in China and Finland.
                  </p>
                  <ul className="space-y-4 mb-10">
                    {[
                      "Highest Purity (Battery Grade)",
                      "Standard for Cathode Precursors",
                      "Used in High-Spec Electroplating",
                      "Pharmaceutical Compliant",
                    ].map((li, i) => (
                      <li
                        key={i}
                        className="flex items-center gap-3 text-navy font-bold text-sm"
                      >
                  ...
                  <div className="pt-8 border-t border-gray-200">
                    ...
                    <p className="text-navy font-bold">
                      EV Batteries & Precision Electronics
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative h-full bg-[#002d52] p-12 rounded-[3rem] overflow-hidden border border-white/5 transition-all duration-500 hover:shadow-2xl hover:bg-[#003463]">
                ...
                <div className="relative z-10 text-white">
                  ...
                  <h3 className="text-3xl font-black mb-6">
                    Recycled Cobalt Sulphate{" "}
                    <span className="text-wine block text-xl">
                      (India Origin)
                    </span>
                  </h3>
                  <p className="text-gray-400 leading-relaxed mb-8">
                    Produced by certified Indian battery recyclers via
                    hydrometallurgical processing of end-of-life Li-ion
                    batteries and industrial scrap.
                  </p>
                  <ul className="space-y-4 mb-10">
                    {[
                      "15–30% Significant Cost Savings",
                      "Lower Carbon Footprint (ESG)",
                      "Alternative to DRC Supply Chains",
                      "Batch-to-Batch COA Stability",
                    ].map((li, i) => (
                      <li
                        key={i}
                  ...
                  <div className="pt-8 border-t border-white/10">
                    ...
                    <p className="text-white font-bold">
                      General Electroplating, Agriculture & Pigments
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <Reveal className="text-center mb-16">
            ...
            <p className="text-gray-500">
              Visual inspection of high-purity cobalt sulphate crystals and
              powder.
            </p>
          </Reveal>
      ...
      <section className="py-32 bg-[#f8f9fb]">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal className="mb-16">
            ...
            <p className="text-gray-500">
              Comprehensive comparative analysis of available grades.
            </p>
          </Reveal>
            ...
            <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100">
              <Table>
                ...
                <TableBody>
                  {(isExpanded ? specs : specs.slice(0, 6)).map((row, idx) => (
                    ...
                    >
                      <TableCell className="font-bold text-navy px-8 py-5">
                        {row.p}
                      </TableCell>
              ...
              <div className="p-8 bg-navy/5">
                <p className="text-xs text-gray-500 leading-relaxed">
                  * Heavy metals compliance documentation available for
                  agricultural and feed-grade use. COA per lot includes Co %,
                  Fe, Ni, Cu, Mn, Na, Cl⁻, moisture, pH, and appearance
                  verification.
                </p>
              </div>
            </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black text-navy mb-6">
              Application <span className="text-wine">Ecosystem</span>
            </h2>
            <p className="text-gray-500">
              Powering high-growth industries across the globe.
            </p>
          </Reveal>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <Reveal variant="fadeLeft">
              <span className="text-wine font-black uppercase tracking-[0.3em] text-sm mb-6 block">
                Sustainability First
              </span>
              <h2 className="text-4xl md:text-5xl font-black mb-8 leading-tight">
                The Recycled Grade{" "}
                <span className="text-wine">Commercial Edge</span>
              </h2>
              <p className="text-gray-400 text-lg font-light mb-10 leading-relaxed">
                Why recycled cobalt sulphate is the preferred choice for
                cost-conscious, ESG-compliant industrial leaders.
              </p>

              <div className="space-y-8">
                {[
                  {
                    t: "30% Cost Efficiency",
                    d: "Recycled material is typically 15–30% cheaper per kg than virgin imported cobalt at equivalent cobalt content.",
                  },
                  {
                    t: "75% Lower Emissions",
                    d: "Dramatically lower GHG emissions compared to virgin mining extraction. Ideal for circular economy requirements.",
                  },
                  {
                    t: "Geopolitical Stability",
                    d: "Alternative to DRC-concentrated supply chains (70%+ global supply). Politically stable India-origin sourcing.",
                  },
                ].map((item, i) => (
              ...
              <div className="relative rounded-[3rem] overflow-hidden shadow-2xl border border-white/10 group">
                ...
                <div className="absolute bottom-10 left-10 right-10">
                  ...
                  <p className="text-gray-400 text-sm">
                    Meets South Korean and European circular economy mandates
                    for battery material sourcing.
                  </p>
                </div>
              </div>
            </Reveal>
              ...
              <div className="bg-white border border-gray-100 p-12 rounded-[3rem] shadow-sm hover:shadow-xl transition-all h-full relative group">
                ...
                <ul className="space-y-6">
                  {[
                    ...
                    <li
                      key={i}
                      className="flex gap-4 items-start text-navy font-medium italic"
                    >
            ...
            <div className="max-w-4xl">
              <Reveal variant="fadeUp">
                <h2 className="text-4xl md:text-5xl font-black text-navy mb-8">
                  Foreign Suppliers <span className="text-wine">Welcome</span>
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-10">
                  We are active importers for the Indian market. We value
                  supplier partnerships built on mutual trust and commercial
                  flexibility, focusing on long-term credit-based arrangements
                  as we grow our volumes.
                </p>
              </Reveal>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
                <Reveal variant="fadeUp" delay={200}>
                  <h4 className="font-black text-navy uppercase tracking-widest text-sm mb-6 border-l-4 border-wine pl-4">
                    We Look For
                  </h4>
                ...
                <Reveal variant="fadeUp" delay={400}>
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Please share: Company, Country, Grade, Capacity (MT), FOB
                    Price, and Payment Terms.
                  </p>
                  <a
                    href="mailto:bd@ochnology.com"
                    className="text-wine font-black hover:underline"
                  >
                    bd@ochnology.com
                  </a>
                </Reveal>
            ...
            <div className="lg:col-span-1">
              <Reveal variant="fadeLeft">
                <h2 className="text-3xl font-black text-navy mb-10">
                  Logistics & <span className="text-wine">Supply</span>
                </h2>
            ...
            <div className="lg:col-span-2">
              <Reveal variant="fadeUp">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    {
                      q: "Virgin vs Recycled difference?",
                      a: "Virgin offers highest purity for EV batteries. Recycled is 15-30% cheaper and ideal for industrial use with slightly higher impurities.",
                    },
                    {
                      q: "Can recycled be used for batteries?",
                      a: "Only if upgraded to battery-grade purity. Standard recycled material is typically reserved for industrial applications.",
                    },
                    {
                      q: "Why important for EV batteries?",
                      a: "It is a key cathode precursor that significantly improves energy density and thermal stability of the battery cell.",
                    },
                    {
                      q: "What documentation is provided?",
                      a: "Full COA, MSDS, recycler certifications, and sustainability reports are provided with every consignment.",
                    },
                    {
                      q: "What is the MOQ?",
                      a: "25 kg for trial orders. We support both R&D-scale testing and large-scale bulk quarterly contracts.",
                    },
                    {
                      q: "Hazard classification?",
                      a: "GHS Category 2 (Suspected carcinogen). PPE is mandatory. We provide comprehensive safety documentation.",
                    },
                  ].map((faq, i) => (
                    <div
                      key={i}
        ...
        <div className="max-w-5xl mx-auto px-6 text-center">
          <Reveal>
            <h2 className="text-5xl font-black mb-8 tracking-tighter">
              Secure Your Cobalt{" "}
              <span className="opacity-50">Supply Channel</span>
            </h2>
            <p className="text-white/70 text-lg mb-12 max-w-2xl mx-auto font-light">
              Contact our technical team for custom gradations, spot pricing,
              and bulk delivery timelines across India and global markets.
            </p>
